...
learning_rate = 1e-14  # The speed of convergence
weight_decay  = 1e-2  # The strength of L2 Regularization (0 == None)
mlp_width     = 4     # Scaling factor for the widths of k1, k2 across the classifer layers
